        ...
        <View style={{ padding: 16, gap: 16, flex: 1 }}>
          ...
          <View>
            ...
            <Text
              ...
              numberOfLines={7}
            >
              Diamonds are inherently a piece of jewelry that brings pride and endless fashion inspiration. Owning your own diamond jewelry is what everyone desires. The ring is crafted from 14K gold and accented with diamonds with 57 precisely cut facets, creating jewelry full of luxury and class.
            </Text>
          </View>
